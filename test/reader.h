...
namespace tomocam {
    class H5Reader {
      ...
      public:
        ...
        Array<float> read_sinogram(int slice) {

            // return value
            Array<float> a(dims_[0], dims_[2]);
            ...
            hsize_t offset[3] = {0, (unsigned long)(slice), 0};
        ...
        Array<float> read_angles(const char * name) {
            ...
            Array<float> a(size, 1);
            ds.read((void *)a.ptr(), H5::PredType::NATIVE_FLOAT, ms, fs);
            return a;
        }
    };
} // namespace tomocam
